    ...
    try:
        with open(animation, 'rb') as infile:
            ...
            for _ in range(num_frames):
                ...
                frame = {'num': len(frames), 'imagedata': imagedata, 'duration': struct.unpack('f', infile.read(4))[0]} #'threshold' : threshold
...
class Animator(QThread):
    def __init__(self, anim : str | Animation | ThresholdAnimation, color : tuple = (255,255,255),*,function : classmethod = None,parent = None):
